...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference("Actor.count") do
      post actors_url, params: { actor: { activo: @actor.activo, fecha_nacimiento: @actor.fecha_nacimiento, nacionalidad: @actor.nacionalidad, nombre: @actor.nombre } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { activo: @actor.activo, fecha_nacimiento: @actor.fecha_nacimiento, nacionalidad: @actor.nacionalidad, nombre: @actor.nombre } }
