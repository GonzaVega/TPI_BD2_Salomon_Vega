...
class ActorsTest < ApplicationSystemTestCase
  ...
  test "should create actor" do
    ...
    check "Activo" if @actor.activo
    fill_in "Fecha nacimiento", with: @actor.fecha_nacimiento
    fill_in "Nacionalidad", with: @actor.nacionalidad
    fill_in "Nombre", with: @actor.nombre
